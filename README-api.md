...
### 2.5. 답글 좋아요 추가
#### 2.5.1. POST /likeAnswer/{answerId}
#### 2.5.2. Request
1) Header
KEY : accessToken
VALUE : 로그인 시 얻은 인증 토큰
...
### 2.6. 답글 좋아요 삭제
#### 2.6.1. DELETE /likeAnswer/{answerId}
#### 2.6.2. Request
1) Header
KEY : accessToken
VALUE : 로그인 시 얻은 인증 토큰
...
### 3.4. 댓글 내용 삭제
#### 3.4.1. DELETE /comment/{commentId}
#### 3.4.2. Request
1) Header
KEY : accessToken
VALUE : 로그인 시 얻은 인증 토큰
...
### 3.5. 댓글 좋아요 추가
#### 3.5.1. POST /likeComment/{commentId}
#### 3.5.2. Request
1) Header
KEY : accessToken
VALUE : 로그인 시 얻은 인증 토큰
...
### 3.6. 댓글 좋아요 삭제
#### 3.6.1. DELETE /likeComment/{commentId}
#### 3.6.2. Request
1) Header
KEY : accessToken
VALUE : 로그인 시 얻은 인증 토큰
