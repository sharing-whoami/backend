...
public class MemberService implements UserDetailsService {
    ...
    public ResponseEntity<?> loginUser(LoginRequestDto requestDto) {
        ...
        String accessToken = jwtTokenProvider.createToken(requestDto.getUserId(),member.get().getRole());
        String refreshToken=jwtTokenProvider.createRefreshToken(requestDto.getUserId(),member.get().getRole());
    ...
    @Transactional
    public ResponseEntity<? extends Object> deleteMember(MemberDeleteRequestDto requestDto) {
        Optional<Member> member=memberRepository.findByUserId(requestDto.getUserId());
        try {
            if (!member.isPresent()){
